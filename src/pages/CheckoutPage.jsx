...
import CheckoutForm from 'features/checkout/component/CheckoutForm';
...
const CheckoutPage = () => {
  return (
    <NavBar pageTitle="Checkout">
      <div className="bg-white">
        <div className="pt-2">
          {/* Product info */}
          <div className="mx-auto max-w-2xl px-4 pb-16 pt-2 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8 lg:px-8 lg:pb-2 lg:pt-2">
